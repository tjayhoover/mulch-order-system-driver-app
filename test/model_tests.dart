...
void main() {
  group('Model Tests', () {
    ...
    test('MulchOrder fromJson Test', () {
      ...
      expect(order.totalBalance, 50.0);
      expect(order.balanceDue, 30.0);
    });
    ...
    test('MulchOrder fromJson with null deliveredTime field', () {
      String json =
          '{"orderNumber":10,"customerName":"customer","address":{"number":11,"street":"street name","town":"town","state":"ST","zip":12345},"customerPhoneNumber":"5555555555","mulchType":"mulch","numberScoops":5,"orderDate":"2023-09-05T00:00:00.000","deliveryIntervalStart":"2023-09-06T10:00:00.000","deliveryIntervalEnd":"2023-09-06T11:00:00.000","deliveredTime":null,"totalBalance":50.0,"balanceDue":30.0}';
